...
class AprobadosClienteView extends StatefulWidget {
  const AprobadosClienteView({Key? key}) : super(key: key);

  @override
  _AprobadosClienteViewState createState() => _AprobadosClienteViewState();
}
...
class _AprobadosClienteViewState extends State<AprobadosClienteView> {
  List<Producto>? items;
