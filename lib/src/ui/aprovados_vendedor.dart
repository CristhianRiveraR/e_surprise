...
class AprobadosVendedorView extends StatefulWidget {
  const AprobadosVendedorView({Key? key}) : super(key: key);

  @override
  _AprobadosVendedorViewState createState() => _AprobadosVendedorViewState();
}
...
class _AprobadosVendedorViewState extends State<AprobadosVendedorView> {
  List<Producto>? items;
